  ...
  en: {
    translation: {
      ...
      hero: {
        ...
        description: 'We support international clients through every stage of renovation and property management in Southern Italy.',
      ...
      about: {
        ...
        whoWeAreDesc:
          'Founded by Andrea Mazzucco and Mirella Lefter, Salento Property Projects was created to help international buyers navigate renovation projects in Southern Italy through a more structured, transparent and operational approach.',

        andreaName: 'Andrea Mazzucco',
        andreaRole: 'Founder & Project Coordinator',
        andreaDesc:
          'With a background influenced by UK operational and project coordination standards, Andrea focuses on helping international buyers navigate the complexities of property renovation in Southern Italy with greater clarity, structure and confidence.',
        ...
        teamDesc:
          'Together, we combine operational coordination and cost management expertise to help international clients approach renovation projects in Southern Italy with greater peace of mind and structure.'
      },
      ...
      servicesPage: {
        title: 'Our Services',
        subtitle: 'Comprehensive solutions for prestige renovations and property management in Southern Italy.',
  ...
  it: {
    translation: {
      ...
      hero: {
        ...
        description: 'Supportiamo clienti internazionali in ogni fase della ristrutturazione e della gestione immobiliare nel Sud Italia.',
      ...
      about: {
        ...
        missionDesc1:
          'Salento Property Projects è nata da una semplice consapevolezza: i proprietari internazionali di immobili nel Sud Italia avevano bisogno di un supporto operativo capace di coordinare in modo più strutturato professionisti, imprese e tutte le fasi del progetto.',
        ...
        whoWeAreDesc:
          'Fondata da Andrea Mazzucco e Mirella Lefter, Salento Property Projects nasce per aiutare clienti internazionali a gestire progetti di ristrutturazione nel Sud Italia attraverso un approccio più strutturato, trasparente e operativo.',
        ...
        teamDesc:
          'Insieme uniamo coordinamento operativo e competenze nella gestione dei costi per aiutare clienti internazionali ad affrontare progetti di ristrutturazione nel Sud Italia con maggiore serenità e organizzazione.'
      },
      ...
      howItWorks: {
        ...
        step3Desc: 'Assembliamo il team e produciamo un cronoprogramma e un budget dettagliato.',
        step4: 'Esecuzione',
      ...
      servicesPage: {
        title: 'I Nostri Servizi',
        subtitle: 'Soluzioni complete per ristrutturazioni di prestigio e gestione immobiliare nel Sud Italia.',
